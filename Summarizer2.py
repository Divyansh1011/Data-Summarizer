...
def executeForAFile(filename,output_file_name) :
    ...
    temp = rbm.test_rbm(dataset = featureMat_normed,learning_rate=0.001, training_epochs=20, batch_size=5,n_chains=5,
             n_hidden=8)
...
# where's the error in the console?
#there is no error here on running this files
#there is arror in running app.py
#THis works fine but conenction i made with the streamlit  for sharing the file gives error
